...
enum Nuul {
    ...
    enum Layout {
        ...
        static let windowHeight: CGFloat = 384
        static let controlHeight: CGFloat = 38
        static let toolbarGlyphSize: CGFloat = 16
    ...
    enum Typography {
        static let display = Font.custom("Geist-Regular", size: 32, relativeTo: .largeTitle)
        static let viewTitle = viewTitleFont()
        static let viewSubtitle = Font.custom("Geist-Regular", size: 24, relativeTo: .title2)
