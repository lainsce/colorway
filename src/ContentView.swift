    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                Text(hexInput)
                    ...
                    .padding(.bottom, Nuul.Spacing.medium)
        ...
        .toolbar {
            ...
            ToolbarItem(placement: .primaryAction) {
                NULToolbarMenu("Color options", systemImage: "ellipsis") {
...
private struct PickerActions: View {
    ...
    var body: some View {
        HStack(alignment: .bottom, spacing: 0) {
            ...
            .buttonStyle(NULButtonStyle(kind: .primary, accentColor: Nuul.accent))
            .frame(
                width: Nuul.Layout.controlHeight,
                height: Nuul.Layout.controlHeight,
                alignment: .leading
            )
